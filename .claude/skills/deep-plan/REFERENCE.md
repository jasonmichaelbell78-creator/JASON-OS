...
**Done when:** All findings addressed or tracked in a debt backlog **Depends on:** All
...
**Phase 0:** Read ROADMAP, explored existing debt ecosystem, found parallel structure.
DIAGNOSIS: aligned with "Evidence-Based" vision, mirror existing debt patterns.

**Phase 1:** 15+ questions in 3 batches.

- Batch 1 (Architecture): Separate system vs extend existing debt system? Impact scale?
  Categories?
...
| `/repo-analysis` | `analysis.json`, `value-map.json` in `.research/analysis/<slug>/` | Phase 0 `## Research Context` section |
