...
- `<JASON_OS_ROOT>\CLAUDE.md` (lines 62-91: §4 Behavioral Guardrails with `[BEHAVIORAL: honor-only]` / `NEEDS_GATE` annotations)
- `<JASON_OS_ROOT>\.claude\hooks\` (8 files; sizes+mtimes in first directory listing)
- `<JASON_OS_ROOT>\.claude\hooks\lib\` (5 files: git-utils, rotate-state, sanitize-input, state-utils, symlink-guard)
- `<JASON_OS_ROOT>\.claude\settings.json` (hook wiring — SessionStart×2, PreToolUse×3, PreCompact×1, PostToolUse×1)
- `<JASON_OS_ROOT>\.claude\agents\` (8 agents — all `/deep-research` pipeline)
- `<JASON_OS_ROOT>\.claude\skills\` (14 skills — directory listing)
- `<JASON_OS_ROOT>\.claude\sync\` (schema/, label/ subtrees)
- `<JASON_OS_ROOT>\.claude\sync\label\lib\sanitize.js` (lines 1-58 — confirms thin wrapper around error-log sanitizer, not a content transformer)
- `<JASON_OS_ROOT>\.claude\state\` (14 state files; per-skill ad-hoc convention)
- `<JASON_OS_ROOT>\scripts\lib\` (8 files; `sanitize-error.cjs:22-39` sensitive-patterns list — error-log scope not content scope)
- `<JASON_OS_ROOT>\.planning\jason-os\BOOTSTRAP_DEFERRED.md` (lines 12-145 deferred items; lines 161-176 sync-mechanism progress pointer)
- `<JASON_OS_ROOT>\.planning\DEBT_LOG.md` (single entry D1)
- `<JASON_OS_ROOT>\.planning\TODOS.md` (23 active, 8 completed)
- `<JASON_OS_ROOT>\.planning\todos.jsonl` (lines 2, 14-21, 28 — T2/T18/T19/T22/T26/T27/T28/T31)
- `<JASON_OS_ROOT>\.planning\piece-3-labeling-mechanism\PLAN.md` (lines 12-27 progress log — S0-S7 done, S8-S14 pending)
- `<JASON_OS_ROOT>\.planning\piece-3-labeling-mechanism\S10_LEARNINGS.md` (lines 1-60 — S10 backfill IN PROGRESS)
- `<JASON_OS_ROOT>\.research\sync-mechanism\BRAINSTORM.md` (lines 1-245 — 5-piece architecture)
- `<JASON_OS_ROOT>\.research\sync-mechanism\piece-1a-discovery-scan-jason-os\findings\D3-hooks-wiring.md` (lines 1-80 — prior hook census)
- `<JASON_OS_ROOT>\.research\migration-skill\BRAINSTORM.md` (§5 Q1/Q2/Q3, §6 dependencies table)

**Findings file:** `<JASON_OS_ROOT>\.research\migration-skill\findings\D3-jason-os-hooks-agents-infra.md`
